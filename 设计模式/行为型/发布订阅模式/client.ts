//发布订阅模式可以看作是观察者模式的一种升级版本，和观察着模式在结构上比较相似
...
const midder = new Intermediary(); //创建一个中间人
const publisher = new Publisher(midder);
const suber = new Subscriber(1, midder);
const suber2 = new Subscriber(2, midder);

suber.subscribe("dizao");
suber.subscribe("ds");
suber2.subscribe("ds");

publisher.publish("ds", "今天天气真好");
publisher.publish("dizao", "今天天气buuuuu好");
